    ...
    <div className="pointer-events-none absolute bottom-24 left-1/2 z-30 -translate-x-1/2">
      {!open ? (
        <button
          ...
          className="pointer-events-auto flex items-center gap-2 rounded-full bg-linear-to-r from-violet-600 to-blue-600 px-4 py-2 text-xs font-semibold text-white shadow-xl transition hover:brightness-110 disabled:opacity-60"
        >
